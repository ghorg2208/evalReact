...
export default function App() {
    return ( <
        ...
        name = "home" / >
        <
        Tabs.Screen component = { Login }
        name = "login"
        options = {
            {
                tabBarIcon: function() {
                    return <Icone size = { 30 }
                    color = { "black" }
                    name = "eye" / >
                }
        ...
        <
        Tabs.Screen component = { GestionUser }
        name = "GestionUser"
        options = {
            {
                tabBarIcon: function() {
        ...
        <
        Tabs.Screen component = { FormCreateUser }
        name = "user"
        options = {
            {
                tabBarIcon: function() {
        ...
        <
        Tabs.Screen component = { NavigationStack2 }
        name = "Gestion"
        options = {
            {
                tabBarIcon: function() {
